...
//    [self.navigationController popToViewController:MainVC animated:YES];
    ...
    NSString* pWWWPath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:@"Pandora/apps/qbsAPP/www"];
    ...
    // 启动该应用
    pAppHandle = [[[PDRCore Instance] appManager] openAppAtLocation:pWWWPath withIndexPath:@"start.html" withArgs:pArgus withDelegate:nil];
